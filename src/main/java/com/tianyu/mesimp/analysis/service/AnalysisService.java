package com.tianyu.mesimp.analysis.service;
...
public class AnalysisService {
	...
	public List<CompanyNum> getIndustryNumData() throws Exception{
		List<CompanyNum> datalist = new ArrayList<CompanyNum>();
		for(Entry<String, CompanyNum> entry: testNumMap.entrySet()) {
